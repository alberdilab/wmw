...
def _warn_unsplit_runs(
    ...
    *,
    ...
    """Name PAIRED runs the archive serves as one unsplit FASTQ holding both mates."""
    ...
    out.warn(
        ...
        f"single unsplit FASTQ holding both mates. Recorded in fastq_url_unsplit "
        f"rather than fastq_url_1, and passed to Drakkar as rawreads_unsplit for "
        f"it to split before preprocessing: {shown}"
    )
